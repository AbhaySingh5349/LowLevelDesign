package Questions.CronParserSystem.Sol2;
...
import Questions.CronParserSystem.Sol2.service.ParserService;
import Questions.CronParserSystem.Sol2.service.ValidationService;
import Questions.CronParserSystem.Sol2.strategy.parser.*;
import Questions.CronParserSystem.Sol2.strategy.validations.CommandComponentDataValidation;
import Questions.CronParserSystem.Sol2.strategy.validations.TimeRangeDataValidation;
...
public class Main {
    public static void main(String[] args) {
        ...
        ValidationService validationService = new ValidationService(Arrays.asList(new CommandComponentDataValidation(), new TimeRangeDataValidation()));

        ParserService parserService = new ParserService(parsers, componentTypeMap, validationService);
