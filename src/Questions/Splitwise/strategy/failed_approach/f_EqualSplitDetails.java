...
public class f_EqualSplitDetails implements f_ISplitDetails {
    private final List<String> commandParams;
    private final Double totalAmount;
    private final int numParticipants;

    public f_EqualSplitDetails(List<String> commandParams, Double totalAmount, int numParticipants) {
